...
graphe_emissions=Image.open(path+'\\emissions.png')
...
st.write("Pour les dates antérieures, c'est la norme NEDC qui était utilisée. Nous avons utilisé un facteur de conversion pour obtenir le Ewlpt pour les données de 2010 à 2018.")
st.write("Pour cela, nous utiliserons des modèles de Machine Learning (Decision tree, RandomForest, KNN).")
