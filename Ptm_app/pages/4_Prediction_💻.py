...
@st.cache_resource
def create_x_tuned(df,groupe,marque,m_tuned,W_tuned,At2_tuned,ec_tuned,ep_tuned,year_tuned):
...
# Import donnees
df=load_data()
if st.checkbox('Cacher jeu de données'):
    pass
else:
...
regressor_name = st.selectbox("Sélection de modèle",("KNN","Decision Tree","Random Forest"))
